                        ...
                        <div class="mt-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                               <div>
                                    ...
                                    <TextInput id="name" v-model="form.name" type="name" class="mt-1 block w-full px-1.5 py-2 border" required />
                                    <InputError class="mt-2" :message="form.errors.name" />
                               </div>
                               <div>
                                   <InputLabel for="lastname" value="Apellido" />
                                   <TextInput id="lastname" v-model="form.lastname" type="lastname" class="mt-1 block w-full px-1.5 py-2 border"
                                       required />
                        ...
                        <div class="mt-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <TextInput id="id_card" v-model="form.id_card" type="id_card" class="mt-1 block w-full px-1.5 py-2 border"
                                        required />
                                    <InputError class="mt-2" :message="form.errors.id_card" />
                                </div>
                                <div>
                                    <InputLabel for="phone" value="Teléfono" />
                                    <TextInput id="phone" v-model="form.phone" type="phone" class="mt-1 block w-full px-1.5 py-2 border"
                                        required />
